...
destination reconstruction from network traffic.

| Countermeasure          | DNS Transparency | DNS Leakage  | TLS Handshake Leakage |
|-------------------------|------------------|--------------|-----------------------|
| DoH (non-ISP resolver)  | ✅ Strong        | ⚠️ Partial   | ❌ None               |
| DoT (non-ISP resolver)  | ✅ Strong        | ⚠️ Partial   | ❌ None               |
| DoQ                     | ✅ Strong        | ⚠️ Partial   | ❌ None               |
| ODoH                    | ✅ Strongest     | ⚠️ Partial   | ❌ None               |
| VPN (leak-protected)    | ✅ Strong        | ✅ Strong    | ✅ Yes (tunneled)     |
| Self-hosted resolver    | ⚠️ Partial       | ✅ Strong    | N/A                   |
